...
public final class GuiElements {
	...
	public static UIEntity createEnumElement(final IIntegerable<?> property, final IntConsumer consumer) {
		return createEnumElement(new UIEnumerable(property.count(), property.getName()), property, consumer);
	}
	...
	public static UIEntity createEnumElement(final UIEnumerable enumerable, final IIntegerable<?> property,
		...
		return createEnumElement(enumerable, property, consumer,
				property.getMaxWidth(mc.font) + 8);
	}
	...
	public static UIEntity createButton(final String name, final int width,
        ...
        settingsEnt.add(new UIClickable(consumer.andThen(e -> handler.play(SimpleSoundInstance.forUI(SoundEvents.UI_BUTTON_CLICK, 1.0f)))))	;
        return settingsEnt;
    }

...
public final class GuiElements {
	...
	public static UIEntity createInputElement(final IIntegerable<?> property, final IntConsumer consumer) {
	...
	public static UIEntity createBoolElement(final IIntegerable<?> property, final IntConsumer consumer) {
	...
	public static UIEntity createEnumElement(final IIntegerable<?> property, final IntConsumer consumer) {
		return createEnumElement(property, consumer, 0);
	}

	public static UIEntity createEnumElement(final IIntegerable<?> property, final IntConsumer consumer,
			final int value) {
		return createEnumElement(new UIEnumerable(property.count(), property.getName()), property, consumer, value);
	}

	public static UIEntity createEnumElement(final UIEnumerable enumerable, final IIntegerable<?> property,
			final IntConsumer consumer) {
		final Minecraft mc = Minecraft.getInstance();
		return createEnumElement(enumerable, property, consumer, property.getMaxWidth(mc.font) + 8, 0);
	}

	public static UIEntity createEnumElement(final UIEnumerable enumerable, final IIntegerable<?> property,
			final IntConsumer consumer, final int value) {
		final Minecraft mc = Minecraft.getInstance();
		return createEnumElement(enumerable, property, consumer, property.getMaxWidth(mc.font) + 8, value);
	}

	public static UIEntity createScrollBar(final UIScrollBox scrollbox, final int insets, final UIScroll scroll) {
		...
		entity.add(new UIScrollBar(scrollbox, insets, input -> {
			...
			final int positionOfList = (int) (Math
					.floor((scrollbox.getWholeBounds() - mode.getBounds(scrollbox.getParent())) * input));
	...
	public static UIEntity createSelectionScreen(final UIEnumerable enumerable, final IIntegerable<?> property) {
	...
	public static UIEntity createScreenBack(final Consumer<UIEntity> entityConsumer) {
		return createScreen(entityConsumer.andThen(e -> e.add(createButton("<", 20, u -> u.getLastUpdateEvent().base.pop()))));
	}

	public static UIEntity createEnumElement(final UIEnumerable enumerable, final IIntegerable<?> property,
			final IntConsumer consumer, final int minWidth, final int value) {
		if (property instanceof DisableIntegerable<?>)
			enumerable.setMin(-1);
		...
		middle.add(new UIClickable(
				entity -> middle.getLastUpdateEvent().base.push(createSelectionScreen(enumerable, property))));
	...
	public static UIEntity createButton(final String name, final int width, final Consumer<UIEntity> consumer) {
		final SoundManager handler = Minecraft.getInstance().getSoundManager();
		...
		settingsEnt.add(new UIClickable(
				consumer.andThen(e -> handler.play(SimpleSoundInstance.forUI(SoundEvents.UI_BUTTON_CLICK, 1.0f)))));
		return settingsEnt;
	}
